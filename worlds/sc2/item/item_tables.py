...
item_table = {
    ...
    item_names.MOTHERSHIP_RECALL: ItemData(405 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 15, SC2Race.PROTOSS, parent=parent_names.MOTHERSHIP),
    item_names.MOTHERSHIP_TALDARIM_BASE_AUXILIARIES: ItemData(406 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 16, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_TALDARIM),
