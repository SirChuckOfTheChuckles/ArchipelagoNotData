...
item_table = {
    ...
    item_names.MOTHERSHIP_PURIFIER_AMPLIFIED_POWER_REROUTER: ItemData(421 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 13, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_PURIFIER),
    item_names.MOTHERSHIP_PURIFIER_PURIFIED_EMBERS: ItemData(422 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 14, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_PURIFIER),
    item_names.MOTHERSHIP_TALDARIM_SHADOW_OF_DEATH: ItemData(423 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 15, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_TALDARIM),
    item_names.MOTHERSHIP_TALDARIM_SOUL_FORGED_CONDUITS: ItemData(424 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 16, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_TALDARIM),
    item_names.MOTHERSHIP_TALDARIM_BLOOD_FUSED_PARTICLES: ItemData(425 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 17, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_TALDARIM),
    ...
    item_names.MOTHERSHIP_AIUR_VALOROUS_RESOLVE: ItemData(546 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.War_Council_2, 17, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_AIUR),
    item_names.MOTHERSHIP_CORE_AIUR_QUANTUM_PROJECTION: ItemData(547 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.War_Council_2, 18, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_AIUR),
    item_names.MOTHERSHIP_PURIFIER_MOBILE_POWER_FIELD: ItemData(548 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.War_Council_2, 16, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_PURIFIER),
