...
item_table = {
    ...
    item_names.MOTHERSHIP_AIUR_ASTRAL_RESTORATION: ItemData(401 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_4, 11, SC2Race.PROTOSS, parent=parent_names.MOTHERSHIP_AIUR),
