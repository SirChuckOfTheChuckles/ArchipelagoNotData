...
item_table = {
    ...
    item_names.MOTHERSHIP_PURIFIER_MOBILE_POWER_FIELD: ItemData(547 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.War_Council_2, 18, SC2Race.PROTOSS, parent=item_names.MOTHERSHIP_PURIFIER),
