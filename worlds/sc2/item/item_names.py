...
KHALAI_DISRUPTER                      = "Khalai Disrupter (Psi Disrupter)"  
SONIC_DISRUPTER                       = "Sonic Disrupter (Psi Disrupter)"  
HIVE_MIND_EMULATOR                    = "Hive Mind Emulator"
BRAINWASHING                          = "Brainwashing (Hive Mind Emulator)"
KHALAI_TAKEOVER                       = "Khalai Takeover (Hive Mind Emulator)"
...
SENSOR_TOWER_ENHANCED_VISION                       = "Enhanced Vision (Sensor Tower)"
...
MOTHERSHIP_TALDARIM_HUNGER_FOR_SLAUGHTER                = "Hunger For Slaughter (Tal'darim Mothership)"
MOTHERSHIP_PURIFIER_PURIFIED_EMBERS                     = "Purified Embers (Purifier Mothership)"
MOTHERSHIP_AIUR_RECURSIVE_PHOTONS                       = "Recursive Photons (Aiur Mothership)"
MOTHERSHIP_EMPOWERED_TIME_WARP                          = "Empowered Time Warp (Mothership)"
MOTHERSHIP_RECALL                                       = "Mothership Recalls (Mothership)"
MOTHERSHIP_TALDARIM_BASE_AUXILIARIES                    = "Base Auxiliaries (Tal'darim Mothership)"
MOTHERSHIP_FIGHTER_HANGAR                               = "Fighter Hangar (Mothership)"
VOID_RAY_DESTROYER_INTERCESSOR_DAWNBRINGER_FLUX_VANES   = "Flux Vanes (Void Ray/Destroyer/Warp Ray/Dawnbringer)"
...
INTERCESSOR_CHRONOCLYSM                                 = "Chronoclysm (Intercessor)"
INTERCESSOR_ENTROPIC_REVERSAL                           = "Entropic Reversal (Intercessor)"
...
OPPRESSOR_OPTIMIZED_LOGISTICS                           = "Optimized Logistics (Oppressor)"
...
INTERCESSOR_LIMINAL_MAGNIFIERS                          = "Liminal Magnifiers (Intercessor)"
...
MOTHERSHIP_AIUR_TEMPORAL_DESTABILIZATION                = "Temporal Destabilization (Aiur Mothership)"
MOTHERSHIP_CORE_AIUR_ADVANCED_REPULSION                 = "Advanced Repulsion (Aiur Mothership Core)"
MOTHERSHIP_CORE_PURIFIER_CONTROLLED_BURN                = "Controlled Burn (Purifier Mothership Core)"
