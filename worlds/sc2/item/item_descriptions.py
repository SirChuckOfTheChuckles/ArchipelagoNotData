...
item_descriptions = {
    ...
    item_names.ARTANIS_LIGHTNING_DASH: "Artanis dashes to a target location, dealing 50 damage to ground enemies in the area and stunning them for 1.5 seconds.",
    item_names.ARTANIS_PHASE_PRISM: "Artanis puts a unit in stasis for 5 seconds, and pulling nearby enemy units towards that unit. Can be recast for Artanis to swap places with the unit in stasis and then pull enemies to himself.",
    item_names.ARTANIS_INSPIRING_PRESENCE: "Friendly units near Artanis deal 4% more damage and take 4% less damage. Both are increased to 8% if the unit shares a Protoss Faction with Artanis.",
    item_names.ARTANIS_VOLTAIC_SHOCK: "Artanis deals 30 damage to enemy units in the area, increased to 60 if they are air units. Air units hit are grounded for 4 seconds.",
    item_names.ARTANIS_ASTRAL_WIND: "Artanis heals for 175 shields and 75 life, and heals nearby friendly units for 75 shields and 25 life. Cooldown is reduced by 5 seconds whenever Artanis deals attack damage.",
    item_names.ARTANIS_CHARGE: "Artanis can now charge to his enemies, gaining massively increased movement speed until he reaches them.",
    item_names.ARTANIS_RESURGENCE: "When Artanis takes lethal damage, he becomes invulnerable for 3 seconds, after which he knocks back all nearby enemies and fully restores his life and shields. 300 second cooldown.",
    item_names.ARTANIS_PSIONIC_ASSAULT: "Allows Artanis to attack air units. This weapon can be enabled and disabled in Artanis' passive menu.",
    item_names.ARTANIS_FORCE_OF_WILL: "Artanis restores +3 shields per second and gains +2 shield armor.",
    item_names.ARTANIS_TEMPERED_IN_TWILIGHT: "Artanis restores 1.5 energy whenever he deals attack damage.",
    item_names.ARTANIS_STRENGTH_IN_UNITY: "Artanis grants bonuses to nearby friendly units based on the Protoss Factions of the unit around him. Artanis gains double these bonuses and counts as the faction of his Weapon Aspect.",
    item_names.ARTANIS_SUPPRESSION_PULSE: "Artanis reduces the attack damage done by nearby enemies by 100% for 4 seconds.",
    item_names.ARTANIS_EXTERMINATE: "Tal'darim Weapon Aspect Active. Artanis goes berserk and attacks the target with 100% increased attack damage, attack speed, and movement speed for 4 seconds, but he is uncommandable until the duration expires or until he or his target dies.",
    item_names.ARTANIS_MALASHS_MALEVOLENCE: "Tal'darim Weapon Aspect Passive. Artanis gains +25% attack speed. While Artanis has Tal'darim Aspect active, his attacks gain 33% splash damage. ",
    item_names.ARTANIS_CLEANSING_SMITE: "Purifier Weapon Aspect Active. Artanis deals 40 damage to nearby enemy units, and deals an additional 40 damage over 4 seconds. The damage over time restores shields to Artanis equal to 75% of the damage done.",
    item_names.ARTANIS_CLOLARIONS_CONFIDENCE: "Purifier Weapon Aspect Passive. Artanis gains +150 shields. While Artanis has Purifier Aspect active, he gains Hardened Shields, reducing damage he takes up to a maximum of 10.",
    item_names.ARTANIS_SHADOW_SLICE: "Nerazim Weapon Aspect Active. Artanis quickly teleports behind an enemy and deals 160 damage to them. This ability's cooldown and cost is refunded by 50% if it kills the targeted enemy.",
    item_names.ARTANIS_RASZAGALS_RHYTHM: "Nerazim Weapon Aspect Passive. When Artanis uses an ability, his next attack deals 100% increased damage. While Artanis has Nerazim Aspect active, the empowered attack will also reduce his cooldowns by 1 seconds and restore 10 energy.",
    item_names.ARTANIS_BLADE_WALTZ: "Aiur Weapon Aspect Active. Artanis dashes to a nearby location, dealing 60 damage to all enemies he passes through. This ability can be recast for free to deal 90 damage, but it cannot damage enemies hit by the original dash.",
    item_names.ARTANIS_TASSADARS_TENACITY: "Aiur Weapon Aspect Passive. Artanis takes 50% reduced damage from spells. While Artanis has Aiur Aspect active, he gains restores shields equal to 10% of the damage done by his spells.",
