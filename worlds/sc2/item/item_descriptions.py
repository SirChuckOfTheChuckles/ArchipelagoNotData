...
item_descriptions = {
    ...
    item_names.NIGHT_WOLF_PREYSEEKER_MISSILES: "Increases Night Wolf weapon and Apocalypse Now! range by 1, and increases missile speed.",
    item_names.NIGHT_WOLF_ENERGIZED_BACKLASH: "Night Wolves restore 0.35 energy whenever they fire a missile.",
    item_names.NIGHT_WOLF_ELUSIVE_ROTORS: "Night Wolves take 30% reduced damage while moving.",
