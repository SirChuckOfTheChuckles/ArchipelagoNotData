...
item_descriptions = {
    ...
    item_names.EMPERORS_SHADOW_KARESHI_PHASING_SUIT: "Labyrinth Cloak lasts longer, increases movement speed, and lets Emperor's Shadows phase through units.",
    ...
    item_names.SON_OF_KORHAL_LOB_SPIDER_MINE: "Allows Sons of Korhal to throw Spider Mines at a target location.",
    ...
    item_names.AEGIS_GUARD_ADDICTIVE_SUPPLEMENTS: "Aegis Guards gain limited early uses of High-Grade Stimpacks.",
    item_names.AEGIS_GUARD_REFRACTIVE_SHRAPNEL: "Aegis Guards release shrapnel around their target after Aegis Barrier is gained or depleted.",
    item_names.AEGIS_GUARD_SOVEREIGN_NEOSTEEL: "Aegis Guards gain life and additional life per rank.",
