...
item_descriptions = {
    ...
    item_names.MOTHERSHIP_AIUR_KHALAI_SHIELD_RECHARGERS: "Aiur Mothership's weapon will also restore shields to a nearby friendly unit. Costs resources to research.",
    ...
    item_names.MOTHERSHIP_HANGAR_INSTALLATIONS: "Allows Motherships install a Hangar to house drones or interceptors, with each Mothership having different drones. Costs resources to research.",
