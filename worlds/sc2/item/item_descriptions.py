...
item_descriptions = {
    ...
    item_names.BULWARK_COMPANY_ARES_CLASS_TARGETING_ADDON: "At Rank 2, increases the Bulwark Company's anti-air attack range by 3\nand ground attack range by 1.",
