...
item_descriptions = {
    ...
    item_names.ARTANIS_WILL_OF_THE_FIRSTBORN: "Artanis gains +200 maximum life. Artanis restores shields equal to 25% of the damage done by his weapons.",
    item_names.ARTANIS_VOLTAIC_SHOCK: "Artanis deals 35 damage to enemy units in the area, increased to 65 if they are air units. Air units hit are grounded for 4 seconds.",
    item_names.ARTANIS_ASTRAL_WIND: "Artanis heals for 175 shields and 75 life, and heals nearby friendly units for 75 shields and 25 life. Cooldown is reduced by 5 seconds whenever Artanis attacks.",
    item_names.ARTANIS_SHIELD_OVERLOAD: "Artanis gains +200 maximum shields. When Artanis casts an ability, he restores shields equal to the energy cost of the ability.",
    ...
    item_names.ARTANIS_TEMPERED_IN_TWILIGHT: "Artanis restores 1.5 energy whenever he attacks.",
    ...
    item_names.ARTANIS_EXTERMINATE: "Tal'darim Weapon Aspect Active. Artanis goes berserk and attacks the target with 100% increased attack damage, attack speed, and movement speed for 4 seconds, but he is uncommandable during this period until he or his target dies.",
    item_names.ARTANIS_MALASHS_MALEVOLENCE: "Tal'darim Weapon Aspect Passive. Artanis' attacks deal an additional 2 damage to 3 enemy units near his target each attack. Scales with weapon damage.",
    ...
    item_names.ARTANIS_CLOLARIONS_CONFIDENCE: "Purifier Weapon Aspect Passive. Artains gains Hardened Shields, reducing damage he takes up to a maximum of 10.",
    item_names.ARTANIS_SHADOW_SLICE: "Nerazim Weapon Aspect Active. Artanis quickly teleports behind an enemy and deals 160 damage to them before teleporting back. This ability's cooldown and cost is refunded by 50% if it kills the targeted enemy.",
    item_names.ARTANIS_RASZAGALS_RHYTHM: "Nerazim Weapon Aspect Passive. When Artanis uses an ability, his next attack deals 100% increased damage and restore 8 energy.",
    item_names.ARTANIS_BLADE_WALTZ: "Aiur Weapon Aspect Active. Artanis dashes to a nearby location, dealing 45 damage to all enemies he passes through and an additionanl 45 damage to enemies near the end of the dash.",
    item_names.ARTANIS_TASSADARS_TEACHINGS: "Aiur Weapon Aspect Passive. When Artanis' uses an ability, he summons a Lesser Psi Storm at the ability's location, dealing 40 damage over 4 seconds.",
