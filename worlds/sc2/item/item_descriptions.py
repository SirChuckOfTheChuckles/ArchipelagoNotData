...
item_descriptions = {
    ...
    item_names.MOTHERSHIP_TALDARIM_SUMMON_DEATH_FLEET: "Allows Tal'darim Motherships to summon 6 Destroyers with timed life.\nCosts resources to be able to use.",
    item_names.MOTHERSHIP_PURIFIER_PLANET_CRACKER: "Allows Purifier Motherships to deal massive damage to ALL OTHER UNITS\nin an increasing area after a brief delay. Costs resources to be able to use.",
    item_names.MOTHERSHIP_AIUR_ASTRAL_RESTORATION: "Allows Aiur Motherships to temporarily increase the radius\nof Cloaking Field and heal allies within it. Costs resources to be able to use.",
    item_names.MOTHERSHIP_TALDARIM_BLOOD_FUSED_PARTICLES: "Taldarim Mothership's primary weapon gains massively attacked speed,\nbut has reduced attack damage. Costs resources to research.",
    item_names.MOTHERSHIP_TALDARIM_SHADOW_OF_DEATH: "Taldarim Motherships slow the attack and movement speed of nearby enemy ground units.\nCosts resources to research.",
    item_names.MOTHERSHIP_TALDARIM_SOUL_FORGED_CONDUITS: "Friendly units that die near Tal'darim Motherships restore health and shields to them,\nincreased if the unit was a Tal'darim unit. Costs resources to research.",
    item_names.MOTHERSHIP_PURIFIER_PURIFIED_EMBERS: "Purifier Motherships reduce the armor and deal damage over time to targets they attack.\nCosts resources to research.",
    item_names.MOTHERSHIP_PURIFIER_CYBROS_SHIELDING: "Purifier Motherships gain damage reduction while using their offensive abilities.\nCosts resources to research.",
    ...
    item_names.MOTHERSHIP_AIUR_FEEDBACK_CONDUCTORS: "Aiur Mothership abilities will cast Feedback on a nearby enemy unit.\nCosts resources to research.",
    ...
    item_names.ARTANIS_RESURGENCE: "When Artanis takes lethal damage, he becomes invulnerable then revives at full health.",
