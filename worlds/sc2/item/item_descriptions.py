...
item_descriptions = {
    ...
    item_names.MOTHERSHIP_AIUR: "Ultimate Aiur vessel. Can use Revitalize Shields and Astral Restoration. Cloaks nearby friendly units. Morphed from a Mothership Core.",
    item_names.MOTHERSHIP_PURIFIER: "Ultimate Purifier vessel. Can use Overload Weapon Systems and Planet Cracker. Creates a power field. Morphed from a Mothership Core.",
    item_names.MOTHERSHIP_TALDARIM: "Ultimate Tal'darim vessel. Can use Thermal Lance, Summon Death Fleet, and Blink.",
    ...
    item_names.MOTHERSHIP_TALDARIM_SUMMON_DEATH_FLEET: "Allows Tal'darim Motherships to summon 6 Destroyers with timed life. Offensive Ability.",
    item_names.MOTHERSHIP_PURIFIER_PLANET_CRACKER: "Allows Purifier Motherships to teleport to a nearby location deal masssive damage in an increasing area. Offensive Ability.",
    item_names.MOTHERSHIP_AIUR_ASTRAL_RESTORATION: "Allows Aiur Motherships to temporarily increase the radius of their Cloaking Field and heal allies within it. Offensive Ability.",
    item_names.MOTHERSHIP_TALDARIM_HUNGER_FOR_SLAUGHTER: "Taldarim Mothership's primary weapon gains 100% attack speed and deals damage quicker, but has reduced attack damage. Auxiliary Upgrade.",
    ...
    item_names.IMMORTAL_ANNIHILATOR_ADVANCED_TARGETING_MECHANICS: "Immortals and Annihilators can attack air units.",
    ...
    item_names.STALWART_STRUT_ENHANCEMENTS: "Increases the movement speed of Stalwarts.",
    ...
    item_names.BLOOD_HUNTER_BRUTAL_EFFICIENCY: "Blood Hunter War Council upgrade. Blood Hunters attack twice as quickly.",
    ...
    # Oracle
    item_names.MOTHERSHIP_TALDARIM_INTEGRATED_POWER: "Tal'darim Mothership War Council upgrade. Allows Motherships to move at full speed outside pylon power.",
    item_names.MOTHERSHIP_PURIFIER_MOBILE_POWER_FIELD: "Purifier Mothership War Council upgrade. Creates a permenant Power Field around the Mothership.",
    item_names.MOTHERSHIP_AIUR_TEMPORAL_DESTABILIZATION: "Aiur Mothership War Council upgrade. Causes attacks to slow attack and move speed of targets it damages.",
    item_names.MOTHERSHIP_CORE_AIUR_ADVANCED_REPULSION: "Aiur Mothership Core War Council upgrade. Allows Aiur Mothership Cores to attack air units and attack while moving.",
    item_names.MOTHERSHIP_CORE_PURIFIER_CONTROLLED_BURN: "Purifier Mothership War Council upgrade. Gain +2 range and 25% attack speed.",
