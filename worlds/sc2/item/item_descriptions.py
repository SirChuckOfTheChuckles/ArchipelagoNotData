...
item_descriptions = {
    ...
    item_names.MOTHERSHIP_TALDARIM_SUMMON_DEATH_FLEET: "Allows Tal'darim Motherships to summon 6 Destroyers with timed life. Offensive Ability, installed at an additional resource cost.",
    item_names.MOTHERSHIP_PURIFIER_PLANET_CRACKER: "Allows Purifier Motherships to teleport to a nearby location deal masssive damage in an increasing area. Offensive Ability, installed at an additional resource cost.",
    item_names.MOTHERSHIP_AIUR_ASTRAL_RESTORATION: "Allows Aiur Motherships to temporarily increase the radius of their Cloaking Field and heal allies within it. Offensive Ability, installed at an additional resource cost.",
