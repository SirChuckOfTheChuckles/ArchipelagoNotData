...
item_descriptions = {
    ...
    item_names.ARTANIS_LIGHTNING_DASH: "Artanis dashes to a target location, dealing 50 damage to ground enemies in the area and stunning them for 1.25 seconds.",
    ...
    item_names.ARTANIS_RESURGENCE: "When Artanis takes lethal damage, he becomes invulnerable for 3 seconds, after which he knocks back all nearby enemies and fully restores his life and shields. 240-second cooldown.",
    ...
    item_names.ARTANIS_EXTERMINATE: "Tal'darim Weapon Aspect Active. Artanis charges his target and begins attacking them, gaining +15 attack damage and 100% attack speed for 6 seconds.",
    item_names.ARTANIS_MALASHS_MALEVOLENCE: "Tal'darim Weapon Aspect Passive. Artanis' attacks deal an additional 7 damage to 4 enemy units near his target.",
    item_names.ARTANIS_CLEANSING_SMITE: "Purifier Weapon Aspect Active. Artanis deals 50 damage to nearby enemy units and an additional 50 damage over 5 seconds. The damage over time restores shields to Artanis equal to 75% of the damage dealt.",
    item_names.ARTANIS_CLOLARIONS_CONFIDENCE: "Purifier Weapon Aspect Passive. Whenever Artanis takes damage, he deals 25 damage to a nearby enemy. Can only occur once per second.",
    item_names.ARTANIS_SHADOW_SLICE: "Nerazim Weapon Aspect Active. Artanis quickly teleports behind an enemy and deals 175 damage to them before teleporting back. This ability's cooldown and cost are refunded by 50% if it kills the targeted enemy.",
    item_names.ARTANIS_RASZAGALS_RHYTHM: "Nerazim Weapon Aspect Passive. When Artanis uses an ability, his next attack deals 25 additional damage and restores 10 energy.",
    item_names.ARTANIS_BLADE_WALTZ: "Aiur Weapon Aspect Active. Artanis dashes forward, dealing 50 damage to all enemies he passes through and an additional 50 damage to enemies near the end of the dash.",
    item_names.ARTANIS_TASSADARS_TEACHINGS: "Aiur Weapon Aspect Passive. When Artanis uses an ability, he deals 10 damage to enemies in its area of effect. Charge empowers his next attack to deal AoE damage.",
